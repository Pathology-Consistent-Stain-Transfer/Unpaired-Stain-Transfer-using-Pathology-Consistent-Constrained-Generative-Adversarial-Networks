...
from mymodels import Generator_unet
...
parser.add_argument('--modelroot', type=str, default='/home/zhangbc/Mydataspace/LST/neuroendocrine/mymodelx288/Cycle_GAN_unet_PN_3_1', help='root directory of the model')
...
parser.add_argument('--loadroot', type=str, default='/home/zhangbc/Mydataspace/LST/neuroendocrine/mymodelx288/Cycle_GAN_unet_PN_3_1/temp', help='continue train root directory of the model')
...
# Networks
netG_A2B = Generator_unet(opt.input_nc, opt.output_nc, 10, alt_leak=True, neg_slope=0.1)
netG_B2A = Generator_unet(opt.output_nc, opt.input_nc, 10, alt_leak=True, neg_slope=0.1)
...
for epoch in range(start_epoch, opt.n_epochs):
    for i, batch in enumerate(dataloader):
        ...
        logger.log({'loss_G': loss_G,
                   ...
                   images={'real_cycle_unet_A': real_A, 'real_cycle_unet_B': real_B,
                           'fake_cycle_unet_A': fake_A, 'fake_cycle_unet_B': fake_B})
