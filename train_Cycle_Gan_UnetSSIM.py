...
parser.add_argument('--modelroot', type=str, default='/home/zhangbc/Mydataspace/LST/breast/mymodelx288/Cycle_GAN_UnetSSIM', help='root directory of the model')
...
parser.add_argument('--loadroot', type=str, default='/home/zhangbc/Mydataspace/LST/breast/mymodelx288/Cycle_GAN_UnetSSIM/temp', help='continue train root directory of the model')
...
for epoch in range(opt.epoch, opt.n_epochs):
    for i, batch in enumerate(dataloader):
        ...
        logger.log({'loss_G': loss_G,
                   ...
                   images={'real_cycleUnetSSIM_A': real_A, 'real_cycleUnetSSIM_B': real_B,
                           'fake_cycleUnetSSIM_A': fake_A, 'fake_cycleUnetSSIM_B': fake_B})
